	...
	return (
		<div className="mt-[40px] sm:mt-[60px]">
			...
			<div className="mt-[40px] sm:mt-[60px]">
				...
				<div className="bg-[#BCEC30] flex flex-col md:p-[50px] lg:flex-row w-full h-[336px] sm:h-[340px] lg:h-[146px] p-[30px] rounded-[20px] justify-between">
					<div className="flex flex-col justify-between w-full sm:w-[284px] h-[78px] sm:h-[86px]">
						<p className="text-[18px] sm:text-[24px] md:text-[28px] text-left">✦ Йога для новичков</p>
						<p className="text-[18px] sm:text-[24px] md:text-[28px] text-left">✦ Классическая йога</p>
					</div>
					<div className="flex flex-col justify-between w-full sm:w-[284px] h-[78px] sm:h-[86px]">
						<p className="text-[18px] sm:text-[24px] md:text-[28px] text-left">✦ Кундалини-йога</p>
						<p className="text-[18px] sm:text-[24px] md:text-[28px] text-left">✦ Йогатерапия</p>
					</div>
					<div className="flex flex-col justify-between w-full sm:w-[284px] h-[78px] sm:h-[86px]">
						<p className="text-[18px] sm:text-[24px] md:text-[28px] text-left">✦ Хатха-йога</p>
						<p className="text-[18px] sm:text-[24px] md:text-[28px] text-left">✦ Аштанга-йога</p>
					</div>
				</div>
			</div>
