	...
	return (
		<div>
			...
			<div className="mt-[60px]">
				<h2 className="text-[40px] mb-[40px] font-medium text-left leading-none">Подойдет для вас, если:</h2>
				...
				<div className="flex mt-[40px] justify-between">
					<div className="w-[368px] h-[141px] pl-[20px] pr-[20px] flex bg-gradient-to-r from-[#151720] to-[#1E212E] items-center rounded-[28px]">
						...
						<p className="text-left text-white text-[24px] ml-[25px] leading-7">
				...
				<h2 className="text-[40px] mt-[60px] mb-[40px] font-medium text-left leading-none">Направления</h2>
